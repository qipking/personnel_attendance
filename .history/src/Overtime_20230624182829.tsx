                    ...
                    <form action="overtime">
                        <fieldset>
                            ...
                            <div class="form-control w-full max-w-xs">
                                <label for="OvertimeID" class="label">
                                    <span class="label-text">What is your name?</span>
                                    <span class="label-text">Top Right label</span>
                                </label>
                                <input id="OvertimeID" type="text" placeholder="Type here" class="input input-primary w-full max-w-xs" />
                                <label class="label">
