...
function Leaderboard() {
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-1 p-8 m-8 ">
                ...
                <div class="py-24 sm:py-32 p-8 bg-base-100 rounded-box shadow">
                    <div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                        <div class="max-w-2xl">
                            ...
                            <p class="mt-6 text-lg leading-8 text-gray-600">爱岗敬业、争创一流、艰苦奋斗、勇于创新、淡泊名利、甘于奉献、执着专注、精益求精、一丝不苟、追求卓越。</p>
                        </div>
