...
function Statistics() {
    const temp:String=response.data.data[0].current_value;
    const heart:String=response.data.data[1].current_value;
    const step:String=response.data.data[2].current_value;
