                            ...
                            <div class="card card-side w-auto glass bg-base-100/50">
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        ...
                                        <div>
                                            <h1 class="text-5xl font-bold">打卡</h1>
                                            <p class="py-6">00人</p>
                                            <button class="btn btn-primary" onclick={() => setWindow("首页")}>上班</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        ...
                                        <div>
                                            <h1 class="text-5xl font-bold">打卡</h1>
                                            <p class="py-6">99人</p>
                                            <button class="btn btn-primary" onclick={() => setWindow("登录")}>下班</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
