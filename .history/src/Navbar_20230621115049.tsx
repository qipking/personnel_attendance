            ...
            <div class="navbar bg-base-100 -mb-5 z-50">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 z-50">
                        ...
                        <li onclick={()=>setWindow("设置")}><a>设置</a></li>
                        <li onclick={()=>setWindow("关于")}><a>关于</a></li>
                    </ul>
                </div>
                <div class="flex-1">
                    <a class="btn btn-ghost normal-case text-xl" onclick={()=>setWindow("首页")}>人员考勤系统</a>
                </div>
                <div class="tabs tabs-boxed bg-base-200">
                    <a class={current() === "请假" ? "tab tab-active" : "tab"} onClick={() => {setCurrent("请假"); setWindow("请假");}}>请假</a>
                    <a class={current() === "加班" ? "tab tab-active" : "tab"} onClick={() => {setCurrent("加班"); setWindow("加班");}}>加班</a>
                    <a class={current() === "出差" ? "tab tab-active" : "tab"} onClick={() => {setCurrent("出差"); setWindow("出差");}}>出差</a>
                    <a class={current() === "统计" ? "tab tab-active" : "tab"} onClick={() => {setCurrent("统计"); setWindow("统计");}}>统计</a>
                </div>
                <div class="flex-none">
