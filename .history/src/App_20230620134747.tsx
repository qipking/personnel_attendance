      ...
      <div>
        <div className="navbar bg-base-300 rounded-box"><font></font>
          <div className="flex-1 px-2 lg:flex-none"><font></font>
            <a className="text-lg font-bold"><div className="drawer"><font></font>
              ...
              <div className="drawer-side"><font></font>
                ...
                <ul className="menu p-4 w-80 h-full bg-base-200 text-base-content"><font></font>
                  {/* Sidebar content here */}<font></font>
