    ...
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-1 m-8 ">
                <h1 class="text-2xl font-bold my-2">低碳积分排行榜</h1>
                <div class="py-24 sm:py-32 p-8 bg-base-100 rounded-box shadow">
                    <div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
                        <div class="max-w-2xl">
                            <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">绿色生产力最佳贡献者</h2>
                            <p class="mt-6 text-lg leading-8">绿水青山就是金山银山，尊重自然保护生态，促进人与自然和谐共生。</p>
                        </div>
