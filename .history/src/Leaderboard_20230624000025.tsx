                                ...
                                {(Employees) => {
                                    return <li>
                                        <div class="flex items-center gap-x-6">
                                            <div class="avatar placeholder">                                                    <span class="indicator-item indicator-start badge badge-secondary">上班总时长:</span>

                                                <div class="bg-neutral-focus text-neutral-content rounded-full w-16">
                                                    <span class="text-2xl">{Employees.AttendanceID}</span>
                                                </div>
                                            </div>
                                            <div>
                                                <h3 class="text-base font-semibold leading-7 tracking-tight">{Employees.Name}</h3>
                                                <p class="text-sm font-semibold leading-6 text-primary ">{Employees.Age}岁</p>
                                            </div>
                                        </div>
                                    </li>;
                                }}
