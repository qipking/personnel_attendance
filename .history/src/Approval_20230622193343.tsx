    ...
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-1 m-8 ">
                ...
                <ul role="list" class="divide-y divide-gray-100 p-8 bg-base-100 rounded-box shadow">
                    ...
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text font-semibold leading-6 text-gray-900">Michael Foster</p>
                                <p class="mt-1 truncate text-lg leading-5 text-gray-500">michael.foster@example.com</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-lg leading-6 text-gray-900">Co-Founder / CTO</p>
