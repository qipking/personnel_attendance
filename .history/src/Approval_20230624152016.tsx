    ...
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-1 grid-rows-1 m-8 ">
                <h1 class="text-2xl font-bold my-2 text-gray-900 ">系统通知</h1>
                <ul role="list" class="p-8 bg-base-100 rounded-box shadow">
                    ...
                    <li class="my-2">
                        <div class="alert alert-warning">
                            <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            <div>
                                <h3 class="font-bold text-lg ">“工作时长”过短</h3>
                                <div class="text-2xs">为了您的奖金，请假不要在上班时间做不相关的事情。</div>
                            </div>
                            <button class="btn btn-wide">收到</button>
                        </div>
                    </li>
