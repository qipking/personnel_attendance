...
async function getHistoricalMotion() {
    ...
    console.log(temperature.data.data.datastreams[0].datapoints[0]);

    for (let i = 0; i < temperature.data.data.count; i++) {
    ...
    return HistoricalMotion;
}

function BusinessTripPage() {

    const HistoricalMotion=getHistoricalMotion();
    return (
        <>
