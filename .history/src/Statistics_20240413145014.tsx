...
function Statistics() {
    temp=response.data.data[0].current_value;
    heart=response.data.data[1].current_value;
    heart=response.data.data[2].current_value;
            ...
            <div class="grid grid-flow-row-dense grid-cols-4 grid-rows-1 m-8 ">
                ...
                <div class="stats bg-base-100 rounded-box shadow col-span-4">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-value text-secondary">{response.data.data[0].current_value}°C</div>
