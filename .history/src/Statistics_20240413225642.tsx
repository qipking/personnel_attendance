...
async function tick() {
    ...
    setHeart(s => response.data.data[0].current_value);
    setTemp(s => response.data.data[1].current_value);
    ...
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-4 grid-rows-1 m-8 ">
                <h1 class="text-2xl font-bold my-2">实时运动信息</h1>
                <div class="stats bg-base-100 rounded-box shadow col-span-4">
                    <div class="stat">
                        ...
                        <div class="stat-title">运动平均心率</div>
