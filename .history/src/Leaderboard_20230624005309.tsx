                                    ...
                                    return <li>
                                        <div class="flex items-center gap-x-6">
                                            <div class="avatar indicator">
                                                <span class="z-40 indicator-item indicator-middle indicator-center badge badge-secondary"></span>
                                                <div class="bg-warning text-neutral-content mask mask-star-2 w-24 shadow">
                                                    <span class="text-neutral text-xl">第{index() + 1}名</span>
                                                </div>
                                            </div>
                                            <div>
