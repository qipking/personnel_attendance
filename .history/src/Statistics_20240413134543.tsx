...
const response = await client.request({
    method: 'GET',
    url: 'http://api.heclouds.com/devices/1052529105/datastreams/temp',
    headers:{'api-key':'=2hXKxDoHTs1Hcd2IxI1HvWkd1c='},
    responseType: ResponseType.JSON
});

function Statistics() {
    console.log(response.data.data.current_value);
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-4 grid-rows-1 m-8 ">
                ...
                <div class="stats bg-base-100 rounded-box shadow col-span-4">
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-value text-secondary">{response.data.data.current_value}°C</div>
