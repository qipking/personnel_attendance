            ...
            <div class="navbar bg-base-100 -mb-5 z-50">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 z-50">
                        ...
                        <li onclick="my_modal_shezhi.showModal()"><a>设置</a></li>
                        <dialog id="my_modal_shezhi" class="modal">
                ...
                <div class="flex-none">
                    ...
                    <div class="dropdown dropdown-end z-50">
                        ...
                        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li onclick={() => { setPage("个人信息"); setCurrent("请假"); }}><a>个人信息</a></li>
                            <li onclick={() => { setPage("工作排名"); setCurrent("请假"); }}><a>工作排名</a></li>
                        </ul>
                    </div>
                </div>
            </div>
