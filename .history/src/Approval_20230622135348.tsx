                    ...
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-1.5xl font-semibold leading-6 text-gray-900">Leslie Alexander</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">不予通过，请假理由不合适。</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <div class="mt-1 flex items-center gap-x-1.5">
                                ...
                                <p class="text-sm leading-6 text-gray-900">请假申请</p>
                            </div>
