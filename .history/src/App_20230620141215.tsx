...
function App() {
  ...
  return (
    <>
      <div>
        <div tabIndex={0} className="collapse bg-base-200"> <font></font>
          <div className="collapse-title text-xl font-medium"><font></font>
            Focus me to see content<font></font>
          </div><font></font>
          <div className="collapse-content"> <font></font>
            <p>tabIndex={0} attribute is necessary to make the div focusable</p><font></font>
          </div><font></font>
        </div>
