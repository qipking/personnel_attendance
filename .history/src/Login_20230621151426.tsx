                            ...
                            <div class="card card-side w-auto glass bg-base-100/50">
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        ...
                                        <div>
                                            <h1 class="text-5xl font-bold">已经上班人数</h1>
                                            <p class="py-6">00人</p>
                                            <button class="btn btn-primary" onclick={() => setWindow("首页")}>打卡</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card lg:card-side w-auto glass bg-base-100/50">
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        <progress class="progress progress-success w-56 "></progress>
                                        <div>
                                            <h1 class="text-5xl font-bold">已经下班人数</h1>
                                            <p class="py-6">99人</p>
                                            <button class="btn btn-primary" onclick={() => setWindow("登录")}>打卡</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
