                                    ...
                                    return <li>
                                        <div class="flex items-center gap-x-6">
                                            <div class="avatar placeholder">
                                                <span class="absolute z-40 indicator-item indicator-middle indicator-center badge badge-accent">第{index() + 1}名</span>
                                                <div class="bg-secondary-focus text-neutral-content mask mask-star-2 w-24">
