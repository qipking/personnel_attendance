...
function Statistics() {
    return (
        <>
            <div class="grid grid-flow-row-dense grid-cols-4 grid-rows-3 m-8 bg-base-100 rounded-box shadow">
                <h1 class="text-2xl font-bold my-2 text-gray-900 ">统计</h1>
                <div class="stats bg-base-100 rounded-box shadow row-span-2">
                <div class="stat">
