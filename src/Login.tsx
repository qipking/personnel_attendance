...
function Login() {
    return (
        <div class="bg-cover bg-center" style="background-image: url(https://api.cyrilstudio.top/bing/image.php/bing?rand=true);">
                                ...
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        ...
                                        <div>
                                            ...
                                            <p class="py-6 text-2xl">上班不迟到,工作不加班!</p>
                                ...
                                <div class="hero max-h-screen">
                                    <div class="hero-content flex-col lg:flex-row">
                                        ...
                                        <div>
                                            ...
                                            <p class="py-6 text-2xl">不忘初心,牢记使命!</p>
                                            <button class="btn btn-primary" onclick={() => setWindow("登录")}>现在下班</button>
                                            <button class="btn btn-primary" onclick={() => setWindow("首页")}>继续上班</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
